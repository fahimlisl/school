...
import { 
  ...
  Trash2, Mail, Phone, Calendar, GraduationCap,
  ChevronLeft, ChevronRight, Plus, UserCheck,
  BookOpen, DollarSign, AlertCircle, CheckCircle,
  RefreshCw, X, User, Shield
} from "lucide-react";
...
export default function StudentList() {
  ...
  const fetchStudentsByClass = async (classNumber) => {
    try {
      ...
      const response = await axios.get(
        `${import.meta.env.VITE_BASE_URL}/admin/fetchAllStudents/${classNumber}`,
        {
          headers: {
  ...
  const updateStats = (studentList) => {
    ...
    const feePending = studentList.filter(s => s.feesPaid === false || !s.feesPaid).length;
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-2">Fetching student data for Class {selectedClass}</p>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-white rounded-2xl p-4 shadow border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">{stats.feePaid}</p>
            </div>
            <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center">
          ...
          <div className="mt-2 text-xs text-gray-500">
            {stats.total > 0 ? `${((stats.feePaid / stats.total) * 100).toFixed(1)}%` : '0%'}
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">{stats.feePending}</p>
            </div>
          ...
          <div className="mt-2 text-xs text-gray-500">
            {stats.total > 0 ? `${((stats.feePending / stats.total) * 100).toFixed(1)}%` : '0%'}
          </div>
        </div>
      </div>
                  ...
                  <td colSpan="6" className="py-12 text-center">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-gray-400 mt-2">
                        {searchQuery ? "Try a different search term" : `No students in Class ${selectedClass}`}
                      </p>
                    </div>
                  </td>
                </tr>
                  ...
                  <tr key={student._id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-4 px-6">
                      <div className="space-y-1">
                        <div className="flex items-center text-sm">
                          ...
                          <span className="text-gray-700">{student.email || 'N/A'}</span>
                        </div>
                        <div className="flex items-center text-sm">
                          <Phone className="w-4 h-4 text-gray-400 mr-2" />
                          <span className="text-gray-700">{student.phoneNumber || 'N/A'}</span>
                        </div>
                      </div>
                    </td>
                    <td className="py-4 px-6">
                      <div className="space-y-1">
                        <div className="flex items-center">
                          ...
                          <span className="font-medium text-gray-700">Class {student.currentClass}</span>
                        </div>
                        <div className="flex items-center">
                          <UserCheck className="w-4 h-4 text-gray-400 mr-2" />
                          <span className="text-sm text-gray-600">Section: {student.section || 'N/A'}</span>
                        </div>
                      </div>
                    </td>
                    <td className="py-4 px-6">
                      <div className="space-y-1">
                        <div className="flex items-center">
                          ...
                          <span className="text-gray-700">{formatDate(student.admissionDate)}</span>
                        </div>
                    ...
                    <td className="py-4 px-6">
                      <div className="space-y-2">
                        <span className={`inline-flex px-3 py-1 rounded-full text-xs font-medium ${getFeeStatus(student).color}`}>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Student ID: {selectedStudent._id?.substring(0, 12)}...</p>
                  </div>
                </div>
                <button
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between py-2 border-b">
                      ...
                      <span className="font-medium">{selectedStudent.email || 'N/A'}</span>
                    </div>
                    <div className="flex justify-between py-2 border-b">
                      <span className="text-gray-600">Phone Number</span>
                      <span className="font-medium">{selectedStudent.phoneNumber || 'N/A'}</span>
                    </div>
                    <div className="flex justify-between py-2 border-b">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between py-2 border-b">
                      ...
                      <span className="font-medium">Class {selectedStudent.currentClass}</span>
                    </div>
                    <div className="flex justify-between py-2 border-b">
                      <span className="text-gray-600">Section</span>
                      <span className="font-medium">{selectedStudent.section || 'N/A'}</span>
                    </div>
                    <div className="flex justify-between py-2 border-b">
                    ...
                    <div className="flex justify-between py-2 border-b">
                      ...
                      <span className="font-medium">{selectedStudent.gurdianName || 'N/A'}</span>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div className="text-center">
                          ...
                          <span className={`inline-flex px-3 py-1 rounded-full text-sm font-medium ${getFeeStatus(selectedStudent).color}`}>
